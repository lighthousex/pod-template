...
module Pod
  class TemplateConfigurator
    ...
    def replace_variables_in_files
      file_names = ['POD_LICENSE', 'POD_README.md', 'NAME.podspec', '.travis.yml', podfile_path, 'Pod/Classes/PROJECTModuleManager.h', 'Pod/Classes/PROJECTModuleManager.m', 'ace-apps/package.json', 'ace-apps/lib/package.json', 'ace-apps/lib/webpack.config.js']
    ...
    def rename_template_files
      ...
      FileUtils.mv "Pod/Assets/PROJECT.plist", "Pod/Assets/#{pod_name}.plist"
      #FileUtils.mv "Pod/PROJECT.bundle/PROJECT.plist", "Pod/PROJECT.bundle/#{pod_name}.plist"
