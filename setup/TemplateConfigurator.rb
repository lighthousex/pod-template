...
module Pod
  class TemplateConfigurator
    ...
    def replace_variables_in_files
      file_names = ['POD_LICENSE', 'POD_README.md', 'NAME.podspec', '.travis.yml', podfile_path, 'Pod/Classes/PROJECTModuleManager.h', 'Pod/Classes/PROJECTModuleManager.m', 'ace-apps/lib/package.json', 'ace-apps/lib/webpack.config.js']
